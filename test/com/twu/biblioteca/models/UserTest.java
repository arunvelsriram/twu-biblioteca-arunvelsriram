...
public class UserTest {
    ...
    @Before
    public void setUp() {
        user = new User("B1012", "password", "Arun", "arunvelsriram@gmail.com", "919629722335");
    }

    @Test
    public void shouldBeAbleToIdentifyAValidUser() {
        boolean actual = user.valid("B1012", "password");
    ...
    public void shouldBeAbleToCheckTheUserName() {
        boolean actual = user.valid("B1111", "password");
    ...
    public void shouldBeAbleToCheckThePassword() {
        boolean actual = user.valid("B1012", "pasword");
    ...
    public void shouldBeAbleToCheckBothUserNameAndPassword() {
        boolean actual = user.valid("B1111", "pasword");
    ...
    public void equalityShouldSatisfyReflexivity() {
        User user = new User("B1011", "passwd", "Murali", "murali123@gmail.com", "919976767676");
    ...
    public void equalityShouldSatisfySymmetricity() {
        User user = new User("B1011", "passwd", "Murali", "murali123@gmail.com", "919976767676");
        User userTwo = new User("B1011", "passwd", "Murali", "murali123@gmail.com", "919976767676");
    ...
    public void equalityShouldSatisfyTransitivity() {
        User user = new User("B1011", "passwd", "Murali", "murali123@gmail.com", "919976767676");
        User userTwo = new User("B1011", "passwd", "Murali", "murali123@gmail.com", "919976767676");
        User userThree = new User("B1011", "passwd", "Murali", "murali123@gmail.com", "919976767676");
