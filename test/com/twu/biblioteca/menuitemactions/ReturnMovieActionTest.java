...
public class ReturnMovieActionTest {
    ...
    public void shouldBeAbleToReturnAMovieByInteractingWithTheController() {
        ReturnMovieAction returnMovieAction = new ReturnMovieAction(itemControllerStub, sectionStub);
        returnMovieAction.performAction();

        verify(itemControllerStub).returnAnItem(sectionStub, MOVIE_RETURN_SUCCESS_MESSAGE, MOVIE_RETURN_FAILURE_MESSAGE);
    }
}